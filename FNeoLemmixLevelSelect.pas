...
var
  ...
  begin
    LoadGraphicWithOverrides(SFGraphicsMenu, aName, UpperCase(StringReplace(aName, '.', '_', [])), BMP32, True);
    if aName2 <> '' then
    begin
      LoadGraphicWithOverrides(SFGraphicsMenu, aName2, UpperCase(StringReplace(aName2, '.', '_', [])), TempBMP, True);
